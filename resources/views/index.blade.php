...
<body>
    ...
    <section id="tentang" class="tentang section">
        <div class="container">
          ...
          <div class="content-row">
            <div class="img-cont">
              <img src="{{ asset('assets/img/logo.png') }}" alt="Logo I-TransEC" />
            </div>
        ...
        <div class="container">
          ...
          <div class="berita-grid">
            ...
            <div class="berita-card">
              <img src="{{ asset('assets/img/donasi.jpg')}}" alt="Berita 1" class="berita-img">
            ...
            <div class="berita-card">
              <img src="{{ asset('assets/img/donasi.jpg')}}" alt="Berita 2" class="berita-img">
              <div class="berita-text">
            ...
            <div class="berita-card">
              <img src="{{ asset('assets/img/logo.png') }}" alt="Berita 3" class="berita-img">
              <div class="berita-text">
    ...
    <div class="carousel-container">
        ...
        <div class="carousel">
            <div class="car">
                <img src="{{ asset('assets/img/dampak/uv.svg') }}" />
                <p>Bumi menjadi hijau kembali</p>
            </div>
            <div class="car">
                <img src="{{ asset('assets/img/dampak/tanam.svg') }}" />
                <p>Polusi udara berkurang dan atmosfer Bumi membaik.</p>
            </div>
            <div class="car">
                <img src="{{ asset('assets/img/dampak/air.svg') }}" />
                <p>Kualitas dan sumber daya alam membaik.</p>
            </div>
            <div class="car">
                <img src="{{ asset('assets/img/dampak/macet.png') }}" />
    ...
    <div class="container">
        <h2 class="fw-bold text-center mb-2">Donasi</h2>
        <div class="row g-2 justify-content-center">
            <div class="col-xxl-2 col-lg-4 col-md-6">
                <div class="card p-3 text-center">
                        <h5 class="fw-bold">Donasi 1</h5>
                    <div class="img-container">
                        <img src="{{ asset('assets/img/donasi.jpg')}}" class="img-1x1">
                    </div>
                        <p>Donasi</p>
